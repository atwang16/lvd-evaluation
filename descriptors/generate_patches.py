...
def generate_descriptors(det, img_db, det_db):
    global directories, image_db_path, detector_db_path, destination_path, patch_size
    args = [directories["patches_executable"], image_db_path, detector_db_path, destination_path, patch_size]
...
if __name__ == "__main__":
    if len(sys.argv) < MIN_NUM_ARGS:
        print("Usage: python3 generate_descriptors.py detector_name database_name")
        sys.exit(1)
    ...
    generate_descriptors(detector, database, detector)